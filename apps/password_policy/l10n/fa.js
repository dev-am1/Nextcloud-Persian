OC.L10N.register(
    "password_policy",
    {
        "Password is expired, please use forgot password method to reset": "گذر واژه منقضی شده، لطفا از روش فراموشی رمز برای بازنشانی استفاده نمایید.",
        "Password must not have been used recently before.": "گذرواژه باید قبلا استفاده نشده باشد.",
