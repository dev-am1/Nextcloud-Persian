OC.L10N.register(
    "files_external",
    {
        ...
        "Verify ACL access when listing files": "درهنگام فهرست بندی فایل ها، دسترسی ACL را تایید کنید.",
        "Check the ACL's of each file or folder inside a directory to filter out items where the user has no read permissions, comes with a performance penalty": "بررسی ACL های هر پرونده یا پوشه در داخل یک فهرست فایل برای فیلتر کردن مواردی که کاربر مجوز خواندن ندارد ، با کاهش کارایی همراه است.",
        "Timeout": "زمان پایان",
