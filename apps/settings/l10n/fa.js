OC.L10N.register(
    "settings",
    {
        ...
        "_and %n other editor_::_and %n other editors_": ["و %n  ویرایش گر دگیر ", "و %n ویرایشگران دیگر "],
        "Enter your name so other users can see who is editing": "نام خود را به منظور نمایش به کاربران دیگر به عنوان ویرایشگر بنویسید.",
        "Edit guest name": "ویرایش نام مهمان",
        "Save guest name": "ذخیره نام مهمان",
        "Add link": "افزودن لینک",
        "Last saved {lastSaved}": "آخرین ذخیره {lastSaved}",
        "The document has been changed outside of the editor. The changes cannot be applied.": "متن خارج از محیط ویرایشگر ",
        "Unpushed changes": "تغییرات اعمال نشده",
        "Unsaved changes": "تغییرات ذخیره نشده",
        "Use current version": "استفاده از نسخه حاضر",
        "Use the saved version": "استفاده از نسخه ذخیره شده",
        "File could not be loaded. Please check your internet connection.": "فایل قابل اجرا نیست، لطفا اتصال اینترنت خود را بررسی نمایید.",
        "Retry": "تلاش دوباره",
        ...
        "Your password was reset": "گذرواژه شما تنظیم مجدد شد",
        ...
        "Your password on %s was reset by an administrator.": "رمز عبور شما توسط یک مدیر در %s تنظیم مجدد شد.",
        "Your password on %s was reset.": "رمز عبور شما در %s تنظیم مجدد گردید.",
        ...
        "Unlimited": "نامحدود",
        "Verifying": "تایید شدن",
        "Nextcloud settings": "تنظیمات حافظه امن ویرا",
        "Two-factor authentication can be enforced for all users and specific groups. If they do not have a two-factor provider configured, they will be unable to log into the system.": "احراز هویت دو عاملی برای همه کاربران و گروههای خاص قابل اجرا است. اگر آنها یک ارائه دهنده دو عاملی پیکربندی شده نداشته باشند ، نمی توانند وارد سیستم شوند.",
        "Enforce two-factor authentication": "اجرای احراز هویت دو عاملی",
        ...
        "Two-factor authentication is enforced for all members of the following groups.": "احراز هویت دو عاملی برای تمام اعضای گروه های زیر فعال شده است.",
        "Enforced groups": "گروههای اجباری",
        "Two-factor authentication is not enforced for members of the following groups.": "احراز هویت دوعاملی برای اعضای گوره های زیر فعال نشده است.",
        ...
        "This app is supported via your current Nextcloud subscription.": "این برنامه از طریق اشتراک فعلی حافظه امن ویرای شما پشتیبانی می شود.",
        "Supported": "پشتیبانی",
        ...
        "This app has no minimum Nextcloud version assigned. This will be an error in the future.": "این برنامه حداقل دارای نسخه بعدی حافظه امن ویرا است. این یک خطا در آینده خواهد بود.",
        "This app has no maximum Nextcloud version assigned. This will be an error in the future.": "این برنامه حداکثر نسخه حافظه امن ویرا اختصاصی ندارد. این یک خطا در آینده خواهد بود.",
        ...
        "_%n app has an update available_::_%n apps have an update available_": ["برای %n  برنامه به روز رسانی موجود است.", "برای %n برنامه به روز رسانی وجود دارد"],
        ...
        "iPhone": "آیفون",
        "iPad": "آیپد",
        "Nextcloud iOS app": "برنامه iOS حافظه امن ویرا ",
        "Nextcloud Android app": "حافظه امن ویرا برای اندروید",
        "Nextcloud Talk for iOS": "حافظه امن ویرا تالک برای iOS",
        "Nextcloud Talk for Android": "گپ حافظه امن ویرا برای اندروید",
        ...
        "Add user in group": "افزودن کاربر به گروه",
        "Set user as admin for": "کاربر به عنوان مدیر برای",
        ...
        "Toggle user actions menu": "تغییر وضعیت لیست فعالیت های کاربر",
        ...
        "Passwordless authentication requires a secure connection.": "احراز هویت بدون گذرواژه نیازمند اتصال ایمن است.",
        "Add WebAuthn device": "افزودن دستگاه برای احراز هویت اینترنتی",
        "Please authorize your WebAuthn device.": "لطفا به دستگاه برای احراز هویت اینترنتی خود مجوز دهید.",
        "Name your device": "برای دستگاهتان نامی انتخاب کنید",
        "Add": "افزودن",
        "Adding your device …": "افزودن دستگاه شما",
        "Server error while trying to add WebAuthn device": "خطای سرور در هنگام افزودن دستگاه برای احراز هویت اینترنتی",
        "Server error while trying to complete WebAuthn device registration": "خطای سرور در هنگام تکمیل ثبت نام دستگاه برای احراز هویت اینترنتی",
        "Unnamed device": "دستگاه بینام",
        "Passwordless Authentication": "احراز هویت بدون گذرواژه",
        "Set up your account for passwordless authentication following the FIDO2 standard.": "با توجه به استاندارد FID02 به حساب کاربری خود احراز هویت بدون رمز اضافه نمایید.",
        "No devices configured.": "هیچ دستگاهی تنظیم نشده.",
        "The following devices are configured for your account:": "دستگاه های زیر برای حساب کاربری شما تنظیم شده است:",
        "Your browser does not support WebAuthn.": "مرورگر شما از احراز هویت اینترنتی حمایت نمی کند.",
        ...
        "Featured apps": "نرم افزارهای اشتراکی",
        ...
        "Check the security of your Nextcloud over <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">our security scan ↗</a>.": "امنیت حافظه امن ویرا خود را در مورد <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">اسکن امنیتی ما ↗ </a>بررسی کنید",
        "Version": "نسخه",
        ...
        "Some jobs haven’t been executed since %s. Please consider increasing the execution frequency.": "برخی وظایف از %s انجام نشده است، لطفا فرکانس اجرا را افزایش دهید.",
        "Some jobs didn’t execute since %s. Please consider switching to system cron.": "برخی از وظایف از زمان %s اجرا نشده اند، لطفا سیستم را به حالت کرون تغییر دهید. ",
        ...
        "Restrict username autocompletion to users within the same groups": "محدود سازی تکمیل خودکار نام کاربری برای کاربرانی که در یک گروه هستند.",
        ...
        "Developed by the {communityopen}Nextcloud community{linkclose}, the {githubopen}source code{linkclose} is licensed under the {licenseopen}AGPL{linkclose}.": "توسعه یافته توسط {communityopen} انجمن حافظه امن ویرا {linkclose} ، {githubopen} کد منبع {linkclose} تحت مجوز است {licenseopen}AGPL{linkclose}. ",
