OC.L10N.register(
    "mail",
    {
        ...
        "Add attachment link from Files": "پیوست را از پیوند پرونده ها اضافه کنید",
        ...
        "Choose a file to share as a link": "انتخاب پرونده برای اشتراک به عنوان پیوند",
        ...
        "Loading …": "بارگذاری …",
        "_{total} message_::_{total} messages_": ["{total} پیام", "{total} پیام ها"],
        ...
        "Sent": "ارسال شده",
        "Trash": "زباله ها",
        "Error while sharing file": "خطا در هنگام اشتراک گذاری پرونده",
        "{from}\n{subject}": "{from}\n{subject}",
        "_%n new message \nfrom {from}_::_%n new messages \nfrom {from}_": ["%n پیام جدید \n از {from}", "%n پیام های جدید \n از {from}"],
        "Nextcloud Mail": "پست الکترونیک حافظه امن ویرا",
