OC.L10N.register(
	"calendar",
	{
		...
		"{filename} is an unsupported file-type": "از {filename} حمایت نمی شود",
		"{filename} could not be parsed": "فایل{filename} قابل تحلیل نیست",
		"No valid files found, aborting import": "فایل معتبری یافت نشد، در حال لغو انتقال",
		...
		"Limit visible events per view": "محدود سازی وقایع در هر نمایش",
