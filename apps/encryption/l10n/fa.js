OC.L10N.register(
    "encryption",
    {
        ...
        "Hey there,\n\nthe admin enabled server-side-encryption. Your files were encrypted using the password '%s'.\n\nPlease login to the web interface, go to the section 'basic encryption module' of your personal settings and update your encryption password by entering this password into the 'old log-in password' field and your current login-password.\n\n": "سلام,\n\n مدیر سرور رمزگذاری سمت سرور را فعال کرد. پرونده های شما با استفاده از رمز ورود '%s' رمز گذاری شدند. \n\n لطفا وارد رابط وب شوید ، به بخش \"ماژول رمزگذاری اولیه\" تنظیمات شخصی خود بروید و با وارد کردن این رمز ورود جدید ، گذرواژه رمزگذاری خود را به روز کنید. \n\n",
        "The share will expire on %s.": "اشتراک‌گذاری در %s منقضی خواهد شد.",
        "Cheers!": "سلامتی!",
        "Hey there,<br><br>the admin enabled server-side-encryption. Your files were encrypted using the password <strong>%s</strong>.<br><br>Please login to the web interface, go to the section \"basic encryption module\" of your personal settings and update your encryption password by entering this password into the \"old log-in password\" field and your current login-password.<br><br>": "سلام،<br><br>مدیر سرور رمزگذاری سمت سرور را فعال کرد. پرونده های شما با استفاده از رمز ورود <strong>%s</strong> رمز گذاری شدند.<br><br>لطفا وارد رابط وب شوید ، به بخش \"ماژول رمزگذاری اولیه\" تنظیمات شخصی خود بروید و با وارد کردن این رمز ورود جدید ، گذرواژه رمزگذاری خود را به روز کنید.<br><br>",
