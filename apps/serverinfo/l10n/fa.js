OC.L10N.register(
    "serverinfo",
    {
        ...
        "Appending \"?format=json\" at the end of the URL gives you the result in JSON.": "افزودن عبارت \"؟ format = json\" به پایان آدرس نتیجه نهایی را در JSON به شما ارائه می دهد.",
